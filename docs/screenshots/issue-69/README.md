...
| An existing custom food can be favorited from the edit toolbar beside the compact save check | ![Favorite and save controls in the custom food edit toolbar](favorite-edit-toolbar.jpg) |
